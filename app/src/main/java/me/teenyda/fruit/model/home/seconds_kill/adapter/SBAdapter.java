package me.teenyda.fruit.model.home.seconds_kill.adapter;
...
public class SBAdapter extends RecyclerView.Adapter<SBAdapter.ViewHolder> {
    ...
    public SBAdapter(Context context, List<KillFruit> fruits) {
        mContext = context;
        mFruits = fruits;
    }
    ...
    @Override
    public void onViewAttachedToWindow(SBAdapter.ViewHolder holder) {
    ...
    @Override
    public void onViewDetachedFromWindow(SBAdapter.ViewHolder holder) {
       int pos = holder.getAdapterPosition();
